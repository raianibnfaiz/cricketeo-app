...
import com.raian.cricketeoapp.adapter.TeamMatchAdapter
import com.raian.cricketeoapp.database.CricketDatabase
import com.raian.cricketeoapp.fragment.League.LeagueMatchesFragmentArgs
...
class AllTeamMatchesFragment : Fragment() {
    val args: AllTeamMatchesFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_team_matches, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch(Dispatchers.Default) {
            val apiResponseResult: Result<List<MatchesOfTeam>?> =
                viewModel.getAllTeamMatches(args.teamId)
            val squadList = apiResponseResult.getOrNull()
            GlobalScope.launch(Dispatchers.Main) {
                if (apiResponseResult.isSuccess) {
                    recyclerView.adapter = TeamMatchAdapter(requireContext(), viewModel, squadList)
