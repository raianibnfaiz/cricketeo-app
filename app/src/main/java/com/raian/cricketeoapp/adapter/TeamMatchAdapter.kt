...
import com.raian.cricketeoapp.fragment.AllTeam.AllTeamMatchesFragmentDirections
...
class TeamMatchAdapter(private val context: Context, val viewModel: CricketViewModel,
                       private val arrayList: List<MatchesOfTeam>?): RecyclerView.Adapter<TeamMatchAdapter.TeamMatchViewHolder>()  {
    private var theTeamList = arrayList


    class TeamMatchViewHolder(private val binding: View) : RecyclerView.ViewHolder(binding) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TeamMatchViewHolder {
        ...
        return TeamMatchAdapter.TeamMatchViewHolder(root)
    }
    ...
    override fun onBindViewHolder(holder: TeamMatchViewHolder, position: Int) {
        ...
        if (currentData != null) {
            ...
            if (!visitorTeamRunsScored?.isEmpty()!!) {
                ...
                holder.visitorTeamRun.text = "score missing"
            }
            ...
            holder.cardView.setOnClickListener {
                ...
                val action =
                    AllTeamMatchesFragmentDirections.actionAllTeamMatchesFragmentToScorecardHostFragment(
                        currentData.id!!
                    )
